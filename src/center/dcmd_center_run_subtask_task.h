...
class DcmdCenterRunSubtaskTask : public CwxTaskBoardTask{
 public:
  enum{
    TASK_STATE_WAITING = CwxTaskBoardTask::TASK_STATE_USER
  };
  DcmdCenterRunSubtaskTask(DcmdCenterApp* app, CwxTaskBoard* taskboard)
    :CwxTaskBoardTask(taskboard)
  {
    reply_conn_id_ = 0;
    msg_taskid_ = 0;
    app_ = app;
