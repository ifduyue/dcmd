...
void protobuf_AddDesc_dcmd_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "\022+\n\'MTYPE_CENTER_AGENT_SUBTASK_CMD_OUTPU"
