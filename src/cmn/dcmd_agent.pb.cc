...
void protobuf_AssignDesc_dcmd_5fagent_2eproto() {
  ...
  static const int AgentTaskCmd_offsets_[18] = {
      ...
      case 2: {
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
         ...
         parse_agent_ips:
          ...
          ::google::protobuf::internal::WireFormat::VerifyUTF8String(
            this->agent_ips(this->agent_ips_size() - 1).data(),
            this->agent_ips(this->agent_ips_size() - 1).length(),
            ::google::protobuf::internal::WireFormat::PARSE);
        } else {
          goto handle_uninterpreted;
        }
...
void AgentTaskCmd::SharedCtor() {
  ...
  svr_path_ = const_cast< ::std::string*>(&::google::protobuf::internal::kEmptyString);
  ::memset(_has_bits_, 0, sizeof(_has_bits_));
}
...
void AgentTaskCmd::SharedDtor() {
  ...
  if (svr_path_ != &::google::protobuf::internal::kEmptyString) {
    delete svr_path_;
  }
  if (this != default_instance_) {
  }
  ...
  while ((tag = input->ReadTag()) != 0) {
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 16: {
        ...
        if (input->ExpectTag(138)) goto parse_svr_path;
        break;
      }
      ...
      case 17: {
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
         ...
         parse_svr_path:
          ...
          ::google::protobuf::internal::WireFormat::VerifyUTF8String(
            this->svr_path().data(), this->svr_path().length(),
            ::google::protobuf::internal::WireFormat::PARSE);
        } else {
          goto handle_uninterpreted;
        }
        if (input->ExpectTag(146)) goto parse_task_arg;
        break;
      }

      // repeated .dcmd_api.KeyValue task_arg = 18;
      case 18: {
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
            ::google::protobuf::internal::WireFormatLite::WIRETYPE_LENGTH_DELIMITED) {
         parse_task_arg:
...
void AgentTaskCmd::SerializeWithCachedSizes(
  ...
  if (has_svr_path()) {
    ::google::protobuf::internal::WireFormat::VerifyUTF8String(
      ...
      ::google::protobuf::internal::WireFormat::SERIALIZE);
    ::google::protobuf::internal::WireFormatLite::WriteString(
      17, this->svr_path(), output);
  }

  // repeated .dcmd_api.KeyValue task_arg = 18;
  for (int i = 0; i < this->task_arg_size(); i++) {
    ::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
      18, this->task_arg(i), output);
  }
