...
const ::google::protobuf::Descriptor* UiTaskCancelWatchReply_descriptor_ = NULL;
const ::google::protobuf::internal::GeneratedMessageReflection*
  UiTaskCancelWatchReply_reflection_ = NULL;
...
void protobuf_AssignDesc_dcmd_5fui_2eproto() {
  ...
  UiTaskWatch_descriptor_ = file->message_type(20);
  ...
  UiTaskWatch_reflection_ =
    new ::google::protobuf::internal::GeneratedMessageReflection(
      ...
      ::google::protobuf::MessageFactory::generated_factory(),
      sizeof(UiTaskWatch));
  UiTaskWatchReply_descriptor_ = file->message_type(21);
  ...
  UiTaskCancelWatch_descriptor_ = file->message_type(22);
  ...
  UiTaskCancelWatchReply_descriptor_ = file->message_type(23);
  static const int UiTaskCancelWatchReply_offsets_[3] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(UiTaskCancelWatchReply, client_msg_id_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(UiTaskCancelWatchReply, state_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(UiTaskCancelWatchReply, err_),
  };
  UiTaskCancelWatchReply_reflection_ =
    new ::google::protobuf::internal::GeneratedMessageReflection(
      UiTaskCancelWatchReply_descriptor_,
      UiTaskCancelWatchReply::default_instance_,
      UiTaskCancelWatchReply_offsets_,
      GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(UiTaskCancelWatchReply, _has_bits_[0]),
      GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(UiTaskCancelWatchReply, _unknown_fields_),
      -1,
      ::google::protobuf::DescriptorPool::generated_pool(),
      ::google::protobuf::MessageFactory::generated_factory(),
      sizeof(UiTaskCancelWatchReply));
...
void protobuf_RegisterTypes(const ::std::string&) {
  ...
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedMessage(
    UiTaskCancelWatchReply_descriptor_, &UiTaskCancelWatchReply::default_instance());
}
...
void protobuf_ShutdownFile_dcmd_5fui_2eproto() {
  ...
  delete UiTaskCancelWatchReply::default_instance_;
  delete UiTaskCancelWatchReply_reflection_;
}
...
void protobuf_AddDesc_dcmd_5fui_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "Cmd\022\025\n\rclient_msg_id\030\001 \002(\005\022\016\n\006opr_id\030\002 \001"
    "(\t\022 \n\004args\030\003 \003(\0132\022.dcmd_api.KeyValue\022\014\n\004"
    "user\030\004 \002(\t\022\016\n\006passwd\030\005 \002(\t\"\207\001\n\021UiExecOpr"
    "CmdReply\022\025\n\rclient_msg_id\030\001 \002(\005\022\"\n\005state"
    "\030\002 \002(\0162\023.dcmd_api.DcmdState\022*\n\006result\030\003 "
    "\003(\0132\032.dcmd_api.AgentOprCmdReply\022\013\n\003err\030\004"
    ...
    "\0162\023.dcmd_api.DcmdState\022&\n\tagentinfo\030\003 \003("
    "\0132\023.dcmd_api.AgentInfo\022\013\n\003err\030\004 \001(\t\"I\n\022U"
    "iInvalidAgentInfo\022\025\n\rclient_msg_id\030\001 \002(\005"
    "\022\014\n\004user\030\002 \002(\t\022\016\n\006passwd\030\003 \002(\t\"\211\001\n\027UiInv"
    "alidAgentInfoReply\022\025\n\rclient_msg_id\030\001 \002("
    "\005\022\"\n\005state\030\002 \002(\0162\023.dcmd_api.DcmdState\022&\n"
    "\tagentinfo\030\003 \002(\0132\023.dcmd_api.AgentInfo\022\013\n"
    "\003err\030\004 \001(\t\"Y\n\020UiTaskScriptInfo\022\025\n\rclient"
    "_msg_id\030\001 \002(\005\022\020\n\010task_cmd\030\002 \002(\t\022\014\n\004user\030"
    ...
    " \002(\005\022\"\n\005state\030\002 \002(\0162\023.dcmd_api.DcmdState"
    ...
    "Reply\022\025\n\rclient_msg_id\030\001 \002(\005\022\"\n\005state\030\002 "
    "\002(\0162\023.dcmd_api.DcmdState\022)\n\007process\030\003 \003("
    "\0132\030.dcmd_api.SubTaskProcess\022\013\n\003err\030\004 \001(\t"
    "\"\212\002\n\tUiTaskCmd\022\025\n\rclient_msg_id\030\001 \002(\005\022\017\n"
    "\007task_id\030\002 \002(\t\022\013\n\003uid\030\003 \002(\005\022\022\n\nsubtask_i"
    "d\030\004 \001(\t\022\n\n\002ip\030\005 \001(\t\022\020\n\010svr_pool\030\006 \001(\t\022\026\n"
    "\016concurrent_num\030\007 \001(\005\022\027\n\017concurrent_rate"
    "\030\010 \001(\005\022\024\n\014task_timeout\030\t \001(\005\022\014\n\004auto\030\n \001"
    "(\010\022#\n\010cmd_type\030\013 \002(\0162\021.dcmd_api.CmdType\022"
    "\014\n\004user\030\014 \002(\t\022\016\n\006passwd\030\r \002(\t\"X\n\016UiTaskC"
    "mdReply\022\025\n\rclient_msg_id\030\001 \002(\005\022\"\n\005state\030"
    "\002 \002(\0162\023.dcmd_api.DcmdState\022\013\n\003err\030\004 \001(\t\""
    "g\n\013UiTaskWatch\022\025\n\rclient_msg_id\030\001 \002(\005\022\017\n"
    "\007task_id\030\002 \002(\t\022\022\n\nlast_state\030\003 \002(\010\022\014\n\004us"
    "er\030\004 \002(\t\022\016\n\006passwd\030\005 \002(\t\"\260\001\n\020UiTaskWatch"
    "Reply\022\025\n\rclient_msg_id\030\001 \002(\005\022(\n\013watch_st"
    "ate\030\002 \002(\0162\023.dcmd_api.DcmdState\022\013\n\003err\030\003 "
    "\001(\t\022%\n\ttask_info\030\004 \002(\0132\022.dcmd_api.TaskIn"
    "fo\022\'\n\013child_tasks\030\005 \003(\0132\022.dcmd_api.TaskI"
    "nfo\"Y\n\021UiTaskCancelWatch\022\025\n\rclient_msg_i"
    "d\030\001 \002(\005\022\017\n\007task_id\030\002 \002(\t\022\014\n\004user\030\003 \002(\t\022\016"
    "\n\006passwd\030\004 \002(\t\"`\n\026UiTaskCancelWatchReply"
    "\022\025\n\rclient_msg_id\030\001 \002(\005\022\"\n\005state\030\002 \002(\0162\023"
    ".dcmd_api.DcmdState\022\013\n\003err\030\003 \001(\t*\220\003\n\007Cmd"
    "Type\022\017\n\013CMD_UNKNOWN\020\000\022\022\n\016CMD_START_TASK\020"
    "\001\022\022\n\016CMD_PAUSE_TASK\020\002\022\023\n\017CMD_RESUME_TASK"
    "\020\003\022\022\n\016CMD_RETRY_TASK\020\004\022\023\n\017CMD_FINISH_TAS"
    "K\020\005\022\026\n\022CMD_CANCEL_SUBTASK\020\006\022\032\n\026CMD_CANCE"
    "L_SVR_SUBTASK\020\007\022\021\n\rCMD_REDO_TASK\020\010\022\025\n\021CM"
    "D_REDO_SVR_POOL\020\t\022\024\n\020CMD_REDO_SUBTASK\020\n\022"
    "\033\n\027CMD_REDO_FAILED_SUBTASK\020\013\022$\n CMD_REDO"
    "_FAILED_SVR_POOL_SUBTASK\020\014\022\026\n\022CMD_IGNORE"
    "_SUBTASK\020\r\022\023\n\017CMD_FREEZE_TASK\020\016\022\025\n\021CMD_U"
    "NFREEZE_TASK\020\017\022\023\n\017CMD_UPDATE_TASK\020\020B\021\n\017c"
    "om.cwinux.dcmd", 3374);
  ...
  UiTaskCancelWatchReply::default_instance_ = new UiTaskCancelWatchReply();
  ...
  UiTaskCancelWatchReply::default_instance_->InitAsDefaultInstance();
...
const UiTaskOutput& UiTaskOutput::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_dcmd_5fui_2eproto();  return *default_instance_;
}
  ...
  while ((tag = input->ReadTag()) != 0) {
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 5: {
        ...
        if (input->ExpectTag(50)) goto parse_svr_pool;
        break;
      }
      
      // optional string svr_pool = 6;
      case 6: {
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
            ::google::protobuf::internal::WireFormatLite::WIRETYPE_LENGTH_DELIMITED) {
         parse_svr_pool:
        ...
        if (input->ExpectTag(56)) goto parse_concurrent_num;
        break;
      }
      
      // optional int32 concurrent_num = 7;
      case 7: {
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
            ::google::protobuf::internal::WireFormatLite::WIRETYPE_VARINT) {
        ...
        if (input->ExpectTag(64)) goto parse_concurrent_rate;
        break;
      }
      
      // optional int32 concurrent_rate = 8;
      case 8: {
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
            ::google::protobuf::internal::WireFormatLite::WIRETYPE_VARINT) {
        ...
        if (input->ExpectTag(72)) goto parse_task_timeout;
        break;
      }
      
      // optional int32 task_timeout = 9;
      case 9: {
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
            ::google::protobuf::internal::WireFormatLite::WIRETYPE_VARINT) {
         parse_task_timeout:
        ...
        if (input->ExpectTag(80)) goto parse_auto;
        break;
      }
      ...
      case 10: {
        ...
        if (input->ExpectTag(88)) goto parse_cmd_type;
        break;
      }
      
      // required .dcmd_api.CmdType cmd_type = 11;
      case 11: {
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
            ::google::protobuf::internal::WireFormatLite::WIRETYPE_VARINT) {
         parse_cmd_type:
      ...
      case 12: {
        ...
        if (input->ExpectTag(106)) goto parse_passwd;
        break;
      }
      
      // required string passwd = 13;
      case 13: {
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
            ::google::protobuf::internal::WireFormatLite::WIRETYPE_LENGTH_DELIMITED) {
         parse_passwd:
...
void UiTaskCmd::SerializeWithCachedSizes(
  ...
  if (has_svr_pool()) {
    ::google::protobuf::internal::WireFormat::VerifyUTF8String(
      ...
      ::google::protobuf::internal::WireFormat::SERIALIZE);
    ::google::protobuf::internal::WireFormatLite::WriteString(
      6, this->svr_pool(), output);
  }
  
  // optional int32 concurrent_num = 7;
  if (has_concurrent_num()) {
    ::google::protobuf::internal::WireFormatLite::WriteInt32(7, this->concurrent_num(), output);
  }
  
  // optional int32 concurrent_rate = 8;
  if (has_concurrent_rate()) {
    ::google::protobuf::internal::WireFormatLite::WriteInt32(8, this->concurrent_rate(), output);
  }
  
  // optional int32 task_timeout = 9;
  if (has_task_timeout()) {
    ::google::protobuf::internal::WireFormatLite::WriteInt32(9, this->task_timeout(), output);
  }
  
  // optional bool auto = 10;
  if (has_auto_()) {
    ::google::protobuf::internal::WireFormatLite::WriteBool(10, this->auto_(), output);
  }
  
  // required .dcmd_api.CmdType cmd_type = 11;
  if (has_cmd_type()) {
    ::google::protobuf::internal::WireFormatLite::WriteEnum(
      11, this->cmd_type(), output);
  }
...
::google::protobuf::uint8* UiTaskCmd::SerializeWithCachedSizesToArray(
  ...
  if (has_svr_pool()) {
    ...
    target =
      ::google::protobuf::internal::WireFormatLite::WriteStringToArray(
        6, this->svr_pool(), target);
  }
  
  // optional int32 concurrent_num = 7;
  if (has_concurrent_num()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteInt32ToArray(7, this->concurrent_num(), target);
  }
  
  // optional int32 concurrent_rate = 8;
  if (has_concurrent_rate()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteInt32ToArray(8, this->concurrent_rate(), target);
  }
  
  // optional int32 task_timeout = 9;
  if (has_task_timeout()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteInt32ToArray(9, this->task_timeout(), target);
  }
  
  // optional bool auto = 10;
  if (has_auto_()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteBoolToArray(10, this->auto_(), target);
  }
  
  // required .dcmd_api.CmdType cmd_type = 11;
  if (has_cmd_type()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteEnumToArray(
      11, this->cmd_type(), target);
  }
...
#ifndef _MSC_VER
const int UiTaskCancelWatchReply::kClientMsgIdFieldNumber;
const int UiTaskCancelWatchReply::kStateFieldNumber;
const int UiTaskCancelWatchReply::kErrFieldNumber;
#endif  // !_MSC_VER

UiTaskCancelWatchReply::UiTaskCancelWatchReply()
  : ::google::protobuf::Message() {
  SharedCtor();
}

void UiTaskCancelWatchReply::InitAsDefaultInstance() {
}

UiTaskCancelWatchReply::UiTaskCancelWatchReply(const UiTaskCancelWatchReply& from)
  : ::google::protobuf::Message() {
  SharedCtor();
  MergeFrom(from);
}

void UiTaskCancelWatchReply::SharedCtor() {
  _cached_size_ = 0;
  client_msg_id_ = 0;
  state_ = 0;
  err_ = const_cast< ::std::string*>(&::google::protobuf::internal::kEmptyString);
...
void UiTaskCancelWatchReply::SharedDtor() {
  if (err_ != &::google::protobuf::internal::kEmptyString) {
    delete err_;
  }
  if (this != default_instance_) {
...
void UiTaskCancelWatchReply::SetCachedSize(int size) const {
  GOOGLE_SAFE_CONCURRENT_WRITES_BEGIN();
  _cached_size_ = size;
  GOOGLE_SAFE_CONCURRENT_WRITES_END();
}
const ::google::protobuf::Descriptor* UiTaskCancelWatchReply::descriptor() {
  protobuf_AssignDescriptorsOnce();
  return UiTaskCancelWatchReply_descriptor_;
}

const UiTaskCancelWatchReply& UiTaskCancelWatchReply::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_dcmd_5fui_2eproto();  return *default_instance_;
}

UiTaskCancelWatchReply* UiTaskCancelWatchReply::default_instance_ = NULL;

UiTaskCancelWatchReply* UiTaskCancelWatchReply::New() const {
  return new UiTaskCancelWatchReply;
}

void UiTaskCancelWatchReply::Clear() {
  if (_has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    client_msg_id_ = 0;
    state_ = 0;
    if (has_err()) {
...
bool UiTaskCancelWatchReply::MergePartialFromCodedStream(
    ::google::protobuf::io::CodedInputStream* input) {
#define DO_(EXPRESSION) if (!(EXPRESSION)) return false
  ::google::protobuf::uint32 tag;
  while ((tag = input->ReadTag()) != 0) {
...
void UiTaskCancelWatchReply::SerializeWithCachedSizes(
    ::google::protobuf::io::CodedOutputStream* output) const {
  // required int32 client_msg_id = 1;
  if (has_client_msg_id()) {
    ::google::protobuf::internal::WireFormatLite::WriteInt32(1, this->client_msg_id(), output);
...
::google::protobuf::uint8* UiTaskCancelWatchReply::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // required int32 client_msg_id = 1;
  if (has_client_msg_id()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteInt32ToArray(1, this->client_msg_id(), target);
...
int UiTaskCancelWatchReply::ByteSize() const {
  int total_size = 0;
...
void UiTaskCancelWatchReply::MergeFrom(const ::google::protobuf::Message& from) {
  GOOGLE_CHECK_NE(&from, this);
  const UiTaskCancelWatchReply* source =
    ::google::protobuf::internal::dynamic_cast_if_available<const UiTaskCancelWatchReply*>(
      &from);
  if (source == NULL) {
    ::google::protobuf::internal::ReflectionOps::Merge(from, this);
  } else {
...
void UiTaskCancelWatchReply::MergeFrom(const UiTaskCancelWatchReply& from) {
  GOOGLE_CHECK_NE(&from, this);
  if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    if (from.has_client_msg_id()) {
      set_client_msg_id(from.client_msg_id());
...
void UiTaskCancelWatchReply::CopyFrom(const ::google::protobuf::Message& from) {
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

void UiTaskCancelWatchReply::CopyFrom(const UiTaskCancelWatchReply& from) {
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool UiTaskCancelWatchReply::IsInitialized() const {
  if ((_has_bits_[0] & 0x00000003) != 0x00000003) return false;
  
  return true;
}

void UiTaskCancelWatchReply::Swap(UiTaskCancelWatchReply* other) {
  if (other != this) {
    std::swap(client_msg_id_, other->client_msg_id_);
    std::swap(state_, other->state_);
    std::swap(err_, other->err_);
...
::google::protobuf::Metadata UiTaskCancelWatchReply::GetMetadata() const {
  protobuf_AssignDescriptorsOnce();
  ::google::protobuf::Metadata metadata;
  metadata.descriptor = UiTaskCancelWatchReply_descriptor_;
  metadata.reflection = UiTaskCancelWatchReply_reflection_;
  return metadata;
}
