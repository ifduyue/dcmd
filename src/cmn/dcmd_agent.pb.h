...
class AgentTaskCmd : public ::google::protobuf::Message {
 public:
  ...
  static const int kSvrPathFieldNumber = 17;
  ...
  inline void set_svr_path(const char* value, size_t size);
  ...
  static const int kTaskArgFieldNumber = 18;
...
class AgentRunningTask : public ::google::protobuf::Message {
 public:
  ...
  inline bool has_svr_pool() const;
  inline void clear_svr_pool();
  static const int kSvrPoolFieldNumber = 2;
  inline const ::std::string& svr_pool() const;
  inline void set_svr_pool(const ::std::string& value);
  inline void set_svr_pool(const char* value);
  inline void set_svr_pool(const char* value, size_t size);
...
inline void AgentTaskCmd::set_svr_path(const char* value, size_t size) {
  set_has_svr_path();
  if (svr_path_ == &::google::protobuf::internal::kEmptyString) {
    svr_path_ = new ::std::string;
  }
...
inline void AgentRunningTask::set_svr_pool(const char* value, size_t size) {
  set_has_svr_pool();
  if (svr_pool_ == &::google::protobuf::internal::kEmptyString) {
    svr_pool_ = new ::std::string;
  }
